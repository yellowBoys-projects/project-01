...
function CArdItem(props) {
	return (
		<Box >
			<Card sx={{ width:{xs:340},height:{xs:300},margin:'0 auto', backgroundColor: '#346bec', textAlign: 'center', borderRadius: '10px' }}>
				<CardContent>
					<Typography variant='bold' sx={{fontSize:{xs:'20px'}}} >action</Typography>
				</CardContent>
				<CardActions >
					<CardMedia sx={{ height: {xs:220}, width:{xs:350},margin:'0 auto',borderRadius:'10px' }} image={props.img} title={props.alt} />
				</CardActions>
			</Card>
		</Box>
	)
